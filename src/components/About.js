...
export default function About(props) {
   ...
   let myStyle = {
            ...
            backgroundColor:props.mode === 'light'?'white':props.mode === 'green'?'#23c178':'black',
            // border:'2px solid',
        ...
        <div className="accordion" id="accordionExample" style={myStyle}>
            ...
            <div className="accordion-item">
                ...
                <div className="accordion-body" style = {myStyle}>
                    ...
                    stastics for a given text. TextUtils reports the number of words and characters. 
            ...
            <div className="accordion-item">
                ...
                <div className="accordion-body" style = {myStyle}>
                    This word counter softwareworks in any web browsers such as Chrome, Firefox, Internet Explorer, Safari, Opera.
